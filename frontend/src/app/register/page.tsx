  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col md:flex-row-reverse bg-background">
      ...
      <div className="md:w-5/12 lg:w-1/2 relative hidden md:flex flex-col justify-end p-16 overflow-hidden bg-muted-background">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2069&auto=format&fit=crop')] bg-cover bg-center grayscale opacity-80 mix-blend-multiply transition-all duration-[2000ms] hover:grayscale-0 animate-slow-zoom" />
